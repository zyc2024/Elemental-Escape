...
/**
 * Capsule-shaped model to support collisions. A standard capsule is made of two circular caps
 * attached to a rectangular core (center). Capsules can be positioned vertically to be used as a
 * hit-box for a player.
 */
public class CapsulePhysicsBody extends PhysicsBody {
    ...
    /** Enum to specify the capsule orientation */
    ...
    /** Shape information for this capsule */
    ...
    /** The width and height of the capsule (the AABB of the capsule) */
    private final Vector2 dimension;

    /** A cache value for accessing the dimensions */
    ...
    /**
     * This method returns the same vector each time its is called, so this cannot be used as a
     * memory allocator.
     *
    ...
    /**
     * Sets the dimensions of this capsule <br> This method does not keep a reference to the
     * parameter.
     *
    ...
    /**
     * Sets the orientation of this capsule, if valid. If the orientation is not valid, then nothing
     * happens and the method return false.
     *
    ...
    /**
     * Sets the seam offset of the core rectangle. If the center rectangle is exactly the same size
     * as the circle radius, you may get catching at the seems. To prevent this, you should make the
     * center rectangle epsilon narrower so that everything rolls off the round shape. This
     * parameter is that epsilon value.
     *
    ...
    /**
     * Creates a new capsule at the origin. The orientation of the capsule will be a full capsule
     * along the major axis.  If width == height, it will default to a vertical orientation. The
     * size is expressed in physics units.
     *
     * @param width  The object width in physics units
     * @param height The object width in physics units
     */
    public CapsulePhysicsBody(float width, float height) {
        this(0, 0, width, height, (width > height ? Orientation.HORIZONTAL : Orientation.VERTICAL));
    }

    /**
     * Creates a new capsule object. The orientation of the capsule will be a full capsule along the
     * major axis.  If width == height, it will default to a vertical orientation. The size is
     * expressed in physics units.
     *
     ...
     * @param height The object width in physics units
     */
    public CapsulePhysicsBody(float x, float y, float width, float height) {
        this(x, y, width, height, (width > height ? Orientation.HORIZONTAL : Orientation.VERTICAL));
    }

    /**
     * Creates a new capsule object with the given orientation. The size is expressed in physics
     * units.
     *
     * @param x      Initial x position of the box center
     * @param y      Initial y position of the box center
     * @param width  The object width in physics units
     * @param height The object width in physics units
     * @param o      The capsule orientation
     */
    public CapsulePhysicsBody(float x, float y, float width, float height, Orientation o) {
        super(x, y);
    ...
    /**
     * Sets the density of this body The density is typically measured in usually in kg/m^2. The
     * density can be zero or positive. You should generally use similar densities for all your
     * fixtures. This will improve stacking stability.
     *
